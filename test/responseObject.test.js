...
var
  ...
  ForbiddenError = require.main.require('errors/forbiddenError'),
  NotFoundError = require.main.require('errors/notFoundError'),
  InternalError = require.main.require('errors/internalError'),
  ServiceUnavailableError = require.main.require('errors/serviceUnavailableError');
